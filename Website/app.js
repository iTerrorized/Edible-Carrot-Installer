  ...
  rowPackageInfoButton.forEach((button) => {
    button.addEventListener('click', e => {
      ...
      if ((packageInfo.keywords?.length ?? 0) === 0) {
        ...
        while (packageInfoKeywords.firstChild) packageInfoKeywords.removeChild(packageInfoKeywords.firstChild);
      ...
      while (packageInfoDependencies.firstChild) packageInfoDependencies.removeChild(packageInfoDependencies.firstChild);
